...
- Monday-Thursday: Read the textbook chapter, do the Sakai quiz online, make progress on the DataCamp lab(s)
  + **Monday 8:10 pm-9:20 pm** (China time): Zoom session with a conceptual review of the chapter material (will not be a repetition of the textbook)
- Thursday 2:45 pm-5:00 pm: weekly lab session, first over Zoom and then in person on campus. The lab session is an opportunity to work on improving your R coding skills. If you are remote, you will be paired up with a partner and will need to submit the lab to me on Slack and be prepared
- Monday-Thursday: Read the textbook chapter, do the Sakai quiz online, make progress on the DataCamp lab(s)
  + **Wednesday 8:10 pm-9:20 pm** (China time): Second weekly Zoom session
